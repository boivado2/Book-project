...
function getPosts() {
    _api.http.get('http://localhost:3000/posts').then(function (books) {
        _ui.ui.showBook(books);
    }).catch(function (err) {
...
function submitPost(e) {
    ...
    if (book === '' || author === '') {
        _ui.ui.showAlert('please put the rigth value', 'alert alert-danger');
    } else {
        ...
        if (id === "") {
            ...
            _api.http.post('http://localhost:3000/posts', books).then(function (book) {
                _ui.ui.showAlert('book Added', 'alert alert-success');
            ...
            _api.http.put('http://localhost:3000/posts/' + id, books).then(function (book) {
                _ui.ui.showAlert('book Upddated', 'alert alert-success');
...
function enableEdit(e) {
    if (e.target.parentElement.classList.contains('edit')) {
        var author = e.target.parentElement.previousElementSibling.textContent;
        var book = e.target.parentElement.previousElementSibling.previousElementSibling.textContent;
...
function deleteBook(e) {
    if (e.target.parentElement.classList.contains('delete')) {
        var id = e.target.parentElement.dataset.id;
        _api.http.delete('http://localhost:3000/posts/' + id).then(function (res) {
            if (confirm('you about to delete a book')) {
                e.target.parentElement.parentElement.remove();
                _ui.ui.showAlert('book deleted!!', 'alert alert-warning');
            }
        }).catch(function (err) {
            return console.log(err);
        });
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 5:
                                responData = _context.sent;
                                return _context.abrupt('return', responData);
...
var http = exports.http = new Htpp();
...
var UI = function () {
    ...
    _createClass(UI, [{
        ...
        value: function showAlert(msg, className) {
            ...
            this.clearAlert();
            var h1 = document.querySelector('.lead');
        ...
        value: function changeFormState(type) {
            if (type === 'edit') {
                ...
                var span = document.querySelector('.span-bottom');
